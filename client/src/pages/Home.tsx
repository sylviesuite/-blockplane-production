  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="relative flex-1 flex flex-col items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container text-center px-4 py-20 flex-1 flex flex-col items-center justify-center">
        ...
        {/* "Choose Your Path to Clarity" at bottom of hero */}
