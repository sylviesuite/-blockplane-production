...
export const materials = mysqlTable("materials", {
  ...
  category: mysqlEnum("category", ["Timber", "Steel", "Concrete", "Earth", "Insulation", "Composites", "Masonry", "Roofing", "Cladding", "Flooring", "Windows", "Mechanical", "Finishes", "Foundation", "Landscaping"]).notNull(),
